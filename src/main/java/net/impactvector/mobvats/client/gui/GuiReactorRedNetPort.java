...
import net.impactvector.mobvats.common.multiblock.block.BlockReactorPart;
...
import net.impactvector.mobvats.common.multiblock.tileentity.TileEntityReactorRedNetPort.CircuitType;
import net.impactvector.mobvats.gui.IBeefGuiControl;
import net.impactvector.mobvats.gui.controls.BeefGuiLabel;
import net.impactvector.mobvats.gui.controls.BeefGuiRedNetChannelSelector;
import net.impactvector.mobvats.gui.controls.grab.BeefGuiGrabSource;
import net.impactvector.mobvats.gui.controls.grab.RedNetConfigGrabTarget;
import net.impactvector.mobvats.gui.controls.grab.RedNetConfigGrabbable;
import net.impactvector.mobvats.net.CommonPacketHandler;
import net.impactvector.mobvats.net.helpers.RedNetChange;
import net.impactvector.mobvats.net.message.ReactorRedNetPortChangeMessage;
...
public class GuiReactorRedNetPort extends BeefGuiBase {
	...
	public GuiReactorRedNetPort(Container container, TileEntityReactorRedNetPort redNetPort) {
		...
		_guiBackground = new ResourceLocation(MobVats.GUI_DIRECTORY + "RedNetPort.png");
	}
	...
	public void initGui() {
		...
		BlockReactorPart reactorPartBlock = (BlockReactorPart)MobVats.blockReactorPart;
