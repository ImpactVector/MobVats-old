...
import net.impactvector.mobvats.common.CircuitType;
import net.impactvector.mobvats.common.multiblock.tileentity.TileEntityReactorRedstonePort;
import net.impactvector.mobvats.gui.controls.BeefGuiLabel;
import net.impactvector.mobvats.gui.controls.GuiSelectableButton;
import net.impactvector.mobvats.net.CommonPacketHandler;
import net.impactvector.mobvats.net.message.multiblock.ReactorRedstonePortChangeMessage;
...
public class GuiReactorRedstonePort extends BeefGuiBase {
	...
	public ResourceLocation getGuiBackground() {
		...
		if (null == GuiReactorRedstonePort.s_backGround)
			GuiReactorRedstonePort.s_backGround = MobVats.createResourceLocation("textures/gui/RedstonePort.png");
	...
	public void initGui() {
		...
		for(CircuitType ct : CircuitType.values()) {
			...
			GuiSelectableButton newBtn = new GuiSelectableButton(buttonOrdinal++, leftX, topY, ct.getIcon(), 0xFF00FF00, this);
			newBtn.displayString = ct.getTooltip();
