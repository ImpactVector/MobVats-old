...
import net.impactvector.mobvats.gui.IBeefListBoxEntry;
import net.impactvector.mobvats.gui.IBeefTooltipControl;
import net.impactvector.mobvats.gui.controls.BeefGuiListBox;
import net.impactvector.mobvats.gui.controls.grab.IBeefGuiGrabbable;
