...
import net.impactvector.mobvats.net.message.ReactorAccessPortChangeDirectionMessage;
import net.impactvector.mobvats.net.message.multiblock.ReactorCommandEjectToPortMessage;
...
public class GuiReactorAccessPort extends BeefGuiBase {
	...
	public ResourceLocation getGuiBackground() {
		...
		if (null == GuiReactorAccessPort.s_backGround)
			GuiReactorAccessPort.s_backGround = MobVats.createResourceLocation("textures/gui/ReactorAccessPort.png");
