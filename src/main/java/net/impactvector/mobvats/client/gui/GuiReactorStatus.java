...
import net.impactvector.mobvats.net.message.multiblock.ReactorChangeWasteEjectionMessage;
import net.impactvector.mobvats.net.message.multiblock.ReactorCommandEjectMessage;
...
//	private GuiIconButton btnWasteEject;
	...
	private BeefGuiLabel mobNameString;
...
//	private BeefGuiFluidBar hotFluidBar;
	...
	public void initGui() {
		...
		btnReactorOn.setTooltip(new String[] { TextFormatting.AQUA + "Activate Vat" });
		btnReactorOff.setTooltip(new String[] { TextFormatting.AQUA + "Deactivate Vat"});
...
//		registerControl(btnWasteEject);
		...
		titleString = new BeefGuiLabel(this, "Vat Control", leftX, topY);
		topY += titleString.getHeight() + 4;

		statusString = new BeefGuiLabel(this, "", leftX+1, topY);
		topY += statusString.getHeight() + 4;

		mobNameString = new BeefGuiLabel(this, "", leftX+1, topY);
...
//		registerControl(hotFluidIcon);
	...
	public ResourceLocation getGuiBackground() {
		...
		if (null == GuiReactorStatus.s_backGround)
			GuiReactorStatus.s_backGround = MobVats.createResourceLocation("textures/gui/ReactorController.png");
	...
	public void updateScreen() {
		...
		for (TileEntityReactorHead head : reactor.attachedHeads) {
			mobNameString.setLabelText(TextFormatting.DARK_GREEN + head.getMobDisplayName() + "\n");
		}
