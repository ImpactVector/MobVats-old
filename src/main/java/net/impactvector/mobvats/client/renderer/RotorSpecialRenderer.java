package net.impactvector.mobvats.client.renderer;
...
//		final IBlockState defaultShaftState = ModBlocks.turbineRotorShaft.getDefaultState();
...
//		final IBlockState blockState = ModBlocks.turbineRotorBlade.getDefaultState().withProperty(Properties.ROTORBLADESTATE, bladeState);
