...
public class Lang {
    ...
    public static final String TAG_CONFIG = "config." + MobVats.MODID + ":";
    public static final String TAG_TOOLTIP = "tooltip." + MobVats.MODID + ":";
    public static final String TAG_WAILA = "waila." + MobVats.MODID + ":";
    public static final String TAG_VALIDATE = "validate." + MobVats.MODID + ":";
    public static final String TAG_CHAT = "chat." + MobVats.MODID + ":";
    public static final String TAG_BOOK = "book." + MobVats.MODID + ":";
    ...
    public static final String TOOLTIP_NOT_CONNECTED = TAG_TOOLTIP + "vat.not_connected";
}
