...
import net.impactvector.mobvats.common.data.loot.Drop;
import net.impactvector.mobvats.common.data.loot.LootPool;
import net.impactvector.mobvats.common.data.loot.LootTable;
...
public class SerializationHelper {
    ...
    public static HashMap<String, LootTable> readHashMapFromFile(File file) throws FileNotFoundException {
        ...
        try {
            ...
            ModEventLog.warning("Failed to load loot table from \'" + file.toString() + "\' " + e.getMessage());
