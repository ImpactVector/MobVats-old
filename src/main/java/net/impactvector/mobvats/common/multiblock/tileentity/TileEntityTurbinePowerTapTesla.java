...
public class TileEntityTurbinePowerTapTesla extends TileEntityTurbinePowerTap {

    public TileEntityTurbinePowerTapTesla() {
    ...
    private PowerTapHandlerTesla _handler;
}
