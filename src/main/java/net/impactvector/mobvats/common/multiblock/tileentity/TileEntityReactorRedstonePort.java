...
import net.impactvector.mobvats.client.gui.GuiReactorRedstonePort;
...
import net.impactvector.mobvats.gui.container.ContainerBasic;
...
public class TileEntityReactorRedstonePort extends TileEntityReactorPartBase implements ITickableMultiblockPart {
	...
	public void onReceiveUpdatePacket(int newType, int outputLevel, boolean greaterThan, boolean activeOnPulse) {
		...
		if (null != outward)
			this.worldObj.notifyBlockOfStateChange(this.getWorldPosition().offset(outward), ModBlocks.reactorRedstonePort);
	}
	...
	*/
	...
	public void onMultiblockServerTick() {
		...
		if (!this.isConnected() || (this.ticksSinceLastUpdate++ < MobVats.CONFIG.ticksPerRedstoneUpdate))
			return;
