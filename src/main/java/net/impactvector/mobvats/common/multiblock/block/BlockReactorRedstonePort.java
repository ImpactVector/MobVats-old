	...
	public void registerRecipes() {
		...
		if (PartTier.REACTOR_TIERS.contains(PartTier.Legacy))
			GameRegistry.addRecipe(this.createItemStack(PartTier.Legacy, 1), "CRC", "RGR", "CRC",
				'C', ModBlocks.reactorCasing.createItemStack(PartTier.Legacy, 1), 'R', Items.REDSTONE, 'G', Items.GOLD_INGOT);

		if (PartTier.REACTOR_TIERS.contains(PartTier.Basic))
			GameRegistry.addRecipe(this.createItemStack(PartTier.Basic, 1), "CRC", "RGR", "CRC",
				'C', ModBlocks.reactorCasing.createItemStack(PartTier.Basic, 1), 'R', Items.REDSTONE, 'G', Items.GOLD_INGOT);
	}
