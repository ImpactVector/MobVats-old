...
//            GameRegistry.addRecipe(ModBlocks.turbineBearing.createItemStack(), "HRH", "DDD", "HRH",
//                    'H', ModBlocks.turbineHousing.createItemStack(PartTier.Legacy, 1), 'D', Items.DIAMOND,
//                    'R', ModBlocks.turbineRotorShaft.createItemStack(PartTier.Legacy, 1));
//
//        if (PartTier.TURBINE_TIERS.contains(PartTier.Basic))
//            GameRegistry.addRecipe(ModBlocks.turbineBearing.createItemStack(), "HRH", "DDD", "HRH",
//                    'H', ModBlocks.turbineHousing.createItemStack(PartTier.Basic, 1), 'D', Items.DIAMOND,
//                    'R', ModBlocks.turbineRotorShaft.createItemStack(PartTier.Basic, 1));
    }
            ...
            if (turbine != null && turbine.isAssembled() && turbine.getActive()) {
                ...
                for (int i = 0; i < numParticles; i++) {
                    ...
                    WorldHelper.spawnVanillaParticles(bearing.getWorld(),
                            MobVats.VALENTINES_DAY ? EnumParticleTypes.HEART : EnumParticleTypes.CLOUD, 1, numParticles,
