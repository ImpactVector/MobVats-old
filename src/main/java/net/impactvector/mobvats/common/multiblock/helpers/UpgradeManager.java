...
//import net.impactvector.mobvats.block.BlockMobFactoryUpgrade;
//import net.impactvector.mobvats.block.BlockMobFactoryUpgradeB;
...
//        upgradeMap.get(EnumSpawnerUpgrade.BLOODMAGIC_III).setRfCostPerTick(Settings.bmIIIRfTick).setSacrificeCount(Settings.bmIIICount).setAltarLifeEssence(Settings.bmIIIAltarLifeEssence);
    ...
    static boolean isUpgradeBlock(Block b) {
        ...
        return false;//b instanceof BlockMobFactoryUpgrade || b instanceof BlockMobFactoryUpgradeB;
    }
