...
import net.impactvector.mobvats.common.multiblock.tileentity.TileEntityReactorGlass;
import net.impactvector.mobvats.common.multiblock.tileentity.TileEntityTurbinePartGlass;
...
public class BlockMultiblockGlass extends BlockTieredPart {
	...
	public void registerRecipes() {
		...
		final boolean useGlassReinforced = MobVats.CONFIG.requireObsidianGlass && OreDictionaryHelper.doesOreNameExist("glassReinforced");
		final boolean useGlassHardened = MobVats.CONFIG.requireObsidianGlass && OreDictionaryHelper.doesOreNameExist("blockGlassHardened");
		final List<String> glassTypes = new ArrayList<>();

//		if (PartType.ReactorGlass == this._type) {

			tiers = PartTier.REACTOR_TIERS;
			casingBlock = ModBlocks.reactorCasing;

//		}
//		else {
//
////			tiers = PartTier.TURBINE_TIERS;
////			casingBlock = ModBlocks.turbineHousing;
//		}
