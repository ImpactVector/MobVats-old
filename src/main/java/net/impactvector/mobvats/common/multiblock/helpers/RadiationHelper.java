...
public class RadiationHelper {
	...
	public static final ReactorInteriorData airData = new ReactorInteriorData(0.5f, 0.5f, 0f);
	public static final ReactorInteriorData waterData = new ReactorInteriorData(1f, 1f, 1f);
	...
	public RadiationData radiate(World world, FuelContainer fuelContainer, TileEntityReactorFuelRod source, FuelAssembly fuelAssembly,
		...
		float rawFuelUsage = (fuelPerRadiationUnit * rawRadIntensity / getFertilityModifier()) * MobVats.CONFIG.fuelUsageMultiplier; // Not a typo. Fuel usage is thus penalized at high heats.
