package net.impactvector.mobvats.common.config;

import net.impactvector.mobvats.common.MobVats;
import net.impactvector.mobvats.common.block.OreType;
...
public class Config extends ConfigHandler {
    ...
    // MOBS
    public boolean useSyringeWhitelist;
    public static String[] syringeBlacklist = new String[0];
    public static String[] syringeWhitelist = new String[0];
    public static int mobSampleSize;
    public static boolean strictFactorySpawns;

    //SPAWNER
    public int spawnerBaseRateTicks;
    public boolean strictRF;
    ...
    public Config() {
        super(MobVats.MODID + ".cfg", MobVats.MODID);
    }
    ...
    protected void loadConfigurationCategories() {
        ...
        this.MOBS = this.getCategory("mobs", "");
        this.SPAWNER = this.getCategory("spawner", "");
    }
    ...
    protected void loadConfigurationValues() {
        ...
        this.enableWorldRegeneration = this.getValue("enableWorldRegeneration", this.WORLDGEN, false, "Run BR World Generation in chunks that have already been generated, but have not been modified by Extreme Reactors before. This is largely useful for worlds that existed before MobVats was released");
        ...
        // MOBS
        this.useSyringeWhitelist = this.getValue("useSyringeWhitelist", this.MOBS, false, "");
        this.syringeBlacklist = this.getValue("syringeBlacklist", this.MOBS, new String[0], "");
        this.syringeWhitelist = this.getValue("syringeWhitelist", this.MOBS, new String[0], "");
        this.mobSampleSize = this.getValue("mobSampleSize", this.MOBS, 500, "");
        this.strictFactorySpawns = this.getValue("strictFactorySpawns", this.MOBS, false, "");

        //SPAWNER
        this.spawnerBaseRateTicks = this.getValue("spawnerBaseRateTicks", this.SPAWNER, 320, "");
        this.strictRF = this.getValue("strictRF", this.SPAWNER, false, "");
    ...
    public void onConfigChanged() {
        ...
        if (this.enableWorldGen) {
            ...
            if (this.yelloriteOreEnableWorldGen) {
                ...
                MobVats.WORLDGEN_ORES.clearOres();
                MobVats.WORLDGEN_ORES.addOre(ModBlocks.brOre.getStateFromType(OreType.Yellorite),
                        Blocks.STONE.getDefaultState(), 11, this.yelloriteOreMaxY,
                        this.yelloriteOrePerCluster, this.yelloriteOreMaxClustersPerChunk);

                MobVats.WHITELIST_WORLDGEN_ORES.clearWhiteList();
                MobVats.WHITELIST_WORLDGEN_ORES.whiteListDimensions(this.dimensionWhitelist);
            }

            if (this.benitoiteOreEnableWorldGen) {

                final IBlockState ore = ModBlocks.brOre.getStateFromType(OreType.Benitoite);
                final IBlockState netherrack = Blocks.NETHERRACK.getDefaultState();

                MobVats.NETHER_ORES.clearOres();
                MobVats.NETHER_ORES.addOre(ore, netherrack , 2, 21, this.benitoiteOrePerCluster, this.benitoiteOreMaxClustersPerChunk);
                MobVats.NETHER_ORES.addOre(ore, netherrack, 104, 123, this.benitoiteOrePerCluster, this.benitoiteOreMaxClustersPerChunk);
            }

            if (this.anglesiteOreEnableWorldGen) {

                MobVats.END_ORES.clearOres();
                MobVats.END_ORES.addOre(ModBlocks.brOre.getStateFromType(OreType.Anglesite),
    ...
    protected ConfigCategory SPAWNER;
    protected ConfigCategory MOBS;
}
