package net.impactvector.mobvats.common.tileentity.base;

import cofh.api.tileentity.IReconfigurableFacing;
import net.impactvector.mobvats.common.interfaces.IBeefReconfigurableSides;
import net.impactvector.mobvats.common.interfaces.IWrenchable;
import net.impactvector.mobvats.gui.IBeefGuiEntity;
import net.impactvector.mobvats.net.CommonPacketHandler;
import net.impactvector.mobvats.net.message.DeviceUpdateExposureMessage;
